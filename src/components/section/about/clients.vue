  ...
  <div class="clients__container container">
    <div class="clients__header">
      <div class="clients__block">
        <header-block class="clients__descr"
          >Growing with our Clients</header-block
        >
        <h2 class="clients__title t-45">Our core values & principles</h2>
        <p class="clients__text t-16">
    ...
    <ul class="clients__card card list-reset">
      <card-ui class="card__item--bacgr">
        <template v-slot:top>
          ...
          >
            ...
            <path
              d="M15.5518 32.0488L26.7056 38.5552L37.8595 32.0488"
              stroke="white"
              stroke-width="2"
            ...
            />
            <path
              d="M15.5518 26.4717L26.7056 32.9781L37.8595 26.4717"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M15.5518 20.8948L26.7056 27.4013L37.8595 20.8948L26.7056 14.3884L15.5518 20.8948Z"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
        ...
        <template v-slot:bot>
          <h3 class="card__title t-20">Creative Ideas</h3>
      ...
      <card-ui class="card__item--bacgr">
        <template v-slot:top>
          ...
          >
            ...
            />
            <path
              d="M14.834 35.6104V26.2773H22.093"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
        ...
        <template v-slot:bot>
          <h3 class="card__title t-20">Best Features</h3>
          <p class="card__text t-16">
      ...
      <card-ui class="card__item--bacgr">
        ...
        <template v-slot:bot>
          <h3 class="card__title t-20">Experience</h3>
          <p class="card__text t-16">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris eget
            accumsan augue Donec aliquam.
          </p>
      ...
      <card-ui class="card__item--bacgr">
        ...
        <template v-slot:bot>
          <h3 class="card__title t-20">Easy Solutions</h3>
          <p class="card__text t-16">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </p>
          <router-link
