      ...
      >
        <card-horizon class="card-horizon__item--border">
          ...
          <template v-slot:right>
            <h3 class="card-horizon__header t-20">Setup Account</h3>
            <p class="card-horizon__description t-16">
        ...
        <card-horizon class="card-horizon__item--border">
          ...
          <template v-slot:right>
            <h3 class="card-horizon__header t-20">Consult with us</h3>
            <p class="card-horizon__description t-16">
        ...
        <card-horizon class="card-horizon__item--border">
          ...
          <template v-slot:right>
            <h3 class="card-horizon__header t-20">Payment & Boost</h3>
            <p class="card-horizon__description t-16">
    ...
    <div class="proccess__right">
      ...
      <ul class="proccess__list list-reset card card--column" role="list">
        <card-ui class="card__item--size">
          ...
          <template v-slot:bot>
            <h3 class="card__title t-20">Consistency</h3>
        ...
        <card-ui class="card__item--size">
          <template v-slot:top>
            ...
            >
              ...
              />
              <path
                d="M22.3467 35.6105V20.0554H29.6057"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M36.8645 13.8334H29.6055V35.6105H36.8645V13.8334Z"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M15.0879 35.6105V26.2775H22.3469"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <template v-slot:bot>
            <h3 class="card__title t-20">Improvement</h3>
            <p class="card__text t-16">
              Podcasting operational change management workflow.
            </p>
          </template>
        ...
        <card-ui class="card__item--size">
          ...
          <template v-slot:bot>
            <h3 class="card__title t-20">Branching</h3>
            <p class="card__text t-16">
              Podcasting operational change management workflow.
            </p>
          </template>
        ...
        <card-ui class="card__item--size">
          <template v-slot:top>
            ...
            >
              ...
              <path
                d="M36.3813 34.838H17.1729V18.8309"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M36.3813 23.6331L29.9785 29.2355L23.5757 24.4334L17.1729 30.0359"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <template v-slot:bot>
            <h3 class="card__title t-20">Company Growth</h3>
            <p class="card__text t-16">
              Podcasting operational change management workflow.
            </p>
          </template>
