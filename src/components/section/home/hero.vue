...
<template>
  <div class="hero__container container">
    <div class="hero__content">
      <h1 class="hero__title t-50">Your small business growth advisors</h1>
      <span class="hero__info t-16"
      ...
      <div class="hero__block">
        ...
        <button class="hero__btn btn-reset">
          ...
          >
            ...
            />
            <path
              d="M18.9082 21.9082H24.4252"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M18.9082 24.6665H24.4252"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
            ...
            />
            <path
              d="M17.5283 12.9434V15.7018"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M21.666 12.9434V15.7018"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M25.8037 12.9434V15.7018"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
          </svg>
