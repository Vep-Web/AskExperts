...
<template>
  <div class="contact__container container">
    <div class="contact__left">
      <header-block class="contact__descr">Proccess</header-block>
      <h2 class="contact__title t-45">Contact Us. It’s Easy.</h2>
      <p class="contact__text t-16">
        Leverage agile frameworks to provide a robust synopsis for high level
        overviews. Iterative approaches to corporate strategy foster
        collaborative.
      </p>
      <ul class="contact__list list-reset card-horizon">
        <card-horizon>
          <template v-slot:left>
            <svg
              class="card-horizon__icon"
              width="53"
              height="53"
              viewBox="0 0 53 53"
              fill="none"
        ...
        <card-horizon>
          ...
          <template v-slot:right>
            <h3 class="card-horizon__header t-16">Monday To Friday</h3>
            <p class="card-horizon__description t-20">9AM - 5PM</p>
          </template>
        </card-horizon>
        <card-horizon>
          <template v-slot:left>
          ...
          <template v-slot:right>
            <h3 class="card-horizon__header t-16">USA Office</h3>
            <p class="card-horizon__description t-20">
    ...
    <form class="contact__form form" action="" method="POST">
      ...
      <button class="form__btn btn-reset link link-black" type="submit">
        Send Message
      </button>
    </form>
  </div>
